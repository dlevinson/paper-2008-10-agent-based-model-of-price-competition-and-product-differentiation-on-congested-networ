...
public class Auto {
	...
	final static int large = 200; //the largest number of nodes on each path;
	...
	public char income; //low; medium; high.
	public boolean trip;
	...
	public Auto(int id, int origin, int destination, double vot,double travelbudget) {
		...
		*/
		...
		else if(vot < 0.3167){ //$12.5/hr
		//else if(vot < 0.483){ //$12.5/hr
			this.income = 'M';
		}
		else{
			this.income = 'H';
